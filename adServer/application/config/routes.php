...
*/
$route['websiteManagement/list/(:num)'] = 'websiteManagement/list/$1/$2';
$route['websiteManagement/delete/(:num)'] = 'websiteManagement/delete/$1';
...
$route['position/notResource/(:num)'] = 'position/notResource/$1';
